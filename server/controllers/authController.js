...
//     const mailOption = {
//       from: process.env.SENDER_EMAIL, // the email address you're sending from (defined in .env)
//       to: user.email, // recipient's email
//       subject: "Password Reset OTP", // email subject
//       text: `Hey ${user.name}, your OTP is ${otp}. It will expire in 24 hours.`, // plain text content
//     };
...
//     if (user.resetOtpExpireAt < Data.now()) {
//       return res.json({ success: false, message: "OTP Expired" });
//     }
